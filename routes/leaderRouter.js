...
leaderRouter.route('/:leaderId')
    ...
    .post(cors.cors, authenticate.verifyAdmin, authenticate.verifyUser, (req, res, next) => {
        res.statusCode = 403;
        res.end(`POST operation not supported on /leaders/${req.params.leaderId}`);
    })
    .put(cors.cors, authenticate.verifyAdmin, authenticate.verifyUser, (req, res, next) => {
    ...
    .delete(cors.cors, authenticate.verifyAdmin, authenticate.verifyUser, (req, res, next) => {
